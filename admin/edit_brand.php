    ...
    include 'header.php'; ?>
        <div class="admin-content-container">
            ...
            // Get brand ID from the URL
                $brand_id = $_GET['id'];
                $db = new Database();
                 // Select brand data for the given ID
                        ...
                        <form id="updateBrand" class="add-post-form col-md-6" method ="POST">
                            ...
                            <div class="form-group">
                                ...
                                $result2 = $db->getResult(); ?>
                                  <!-- Dropdown list for brand category -->
                                <select name="brand_cat" class="form-control brand_category">
                                    <option value="" selected disabled>Select Category</option>
                                    <?php if (count($result) > 0) {  ?>
                                        <?php foreach($result2 as $row2) { ?>
                                             <!-- Display categories as options, with the selected category pre-selected -->
